...
def calculates_results_stats(results_dic):
    ...
    """        
    # Create an empty dictionary to hold the results statistics
    results_stats_dic = {}

    # Set initial values for the statistics
    ...
    # Iterate through the results_dic and calculate the statistics
